...
#### 2022
[Advances in Neural Rendering](https://arxiv.org/abs/2111.05849) : 全面且详细地介绍了神经渲染（Neural Rendering）
...
#### （2）深度监督 & 点云
通过对从 LiDAR 或 SfM 获取的**点云对预期深度进行监督**，使模型收敛速度更快，且质量更高，并且需要更少的训练视图，适用于 few-shot/稀疏视图的 NeRF 场景。
